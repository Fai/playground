...
describe("Challenge - Bullied Boy", function () {
    ...
    it('Execution', async function () {
        ...
        let BulliedBoy = await ethers.getContractFactory('BulliedBoy', player);
        let bulliedBoy = await BulliedBoy.deploy();
        await bulliedBoy.connect(player).bully(schoolRunner.address);
    });
